...
int ValueEffectSrver[4];
int Drop;
int Exp;
int Cash;
HudController _HudControl;
std::vector<LojaDonate> ControlLojaDonate = std::vector<LojaDonate>();

LojaDonateInfor					ControlLojaDonateInfor = { 0, };
...
int g_bDebugMsg = 1;
int g_nReflection;
char g_szFontName[128] = { "NanumGothic" };
int g_nFontBold = 500;
int g_nLangIndex = 0;
