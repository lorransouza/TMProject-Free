...
int SGridControl::MouseOver(int nCellX, int nCellY, int bPtInRect)
{
	...
	else
	{
			...
			pItem->m_pItem->sIndex == 4899 || pItem->m_pItem->sIndex >= 3368 && pItem->m_pItem->sIndex <= 3376)
		{
			...
			pFScene->m_pParamText[13]->SetText(szText, 0);
			pFScene->m_pParamText[13]->SetTextColor(0);
			pFScene->m_pParamText[12]->SetText(szText, 0);
			pFScene->m_pParamText[12]->SetTextColor(LawnGreen);
		}
		int nItemHonra = 0;
		if (pItem->m_pItem->sIndex >= 412 && pItem->m_pItem->sIndex <= 413 ||
			...
			pItem->m_pItem->sIndex >= 2390 && pItem->m_pItem->sIndex <= 2419)
		{
			...
			pFScene->m_pParamText[13]->SetTextColor(0);
			pFScene->m_pParamText[12]->SetText(szText, 0);
			pFScene->m_pParamText[12]->SetTextColor(DeepSkyBlue);
		}
		int nItemitem = 0;
		if (pItem->m_pItem->sIndex == 4174 ||
			...
			pItem->m_pItem->sIndex == 4328)
		{
			...
			pFScene->m_pParamText[13]->SetTextColor(0);
			pFScene->m_pParamText[12]->SetText(szText, 0);
			pFScene->m_pParamText[12]->SetTextColor(Yellow);
		}
